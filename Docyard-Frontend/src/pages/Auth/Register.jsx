          ...
          <div className="w-full max-w-2xl">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-8 inline-flex h-12 w-full items-center justify-center rounded-lg bg-[#0A3A63] px-7 text-sm font-semibold text-white transition-colors hover:bg-[#082F50] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading
