...
const Home = () => {
  return (
    <main className="min-h-screen bg-paper text-ink">
      ...
      <section className="border-b border-line px-6 py-20 md:px-12 md:py-28">
        ...
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="grid items-end gap-12 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            <div>
              ...
              <h1 className="mt-5 max-w-4xl font-display text-6xl font-semibold leading-[0.95] tracking-tight md:text-8xl">
                Knowledge,
                <br />
              ...
              <p className="mt-8 max-w-xl text-base leading-7 text-ink-soft md:text-lg">
      ...
      <section className="border-y border-line bg-paper-raised px-6 md:px-12">
        ...
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="grid md:grid-cols-3">
            ...
            <article className="border-b border-line py-10 md:border-b-0 md:border-r md:pr-10">
            ...
            <article className="border-b border-line py-10 md:border-b-0 md:border-r md:px-10">
        ...
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <div>
              ...
              <h2 className="mt-5 max-w-3xl font-display text-5xl font-semibold leading-[1] md:text-7xl">
                Find something
                worth keeping.
              </h2>
      ...
      <section className="border-t border-line px-6 py-8 md:px-12">

        <div className="mx-auto flex max-w-[1180px] flex-col justify-between gap-4 md:flex-row">
